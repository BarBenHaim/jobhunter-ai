    ...
    queryFn: async () => [
      {
        ...
        recommendation: 'APPROVE - Strong match with excellent skill alignment',
        aiReasoning: 'This role perfectly aligns with your React expertise and career goals. The company has strong reviews and the compensation exceeds your minimum threshold.',
        description: 'Senior React Developer needed for innovative team building customer-facing applications. 5+ years experience required. Hybrid role in San Francisco.',
        generatedCV: `John Doe
Senior React Developer | San Francisco, CA

PROFESSIONAL SUMMARY
Experienced React developer with 6+ years building scalable web applications. Proven track record of delivering high-performance solutions and mentoring junior developers.

EXPERIENCE
Senior React Developer | TechStartup Inc | 2021-Present
...
BS Computer Science | State University | 2018`,
      ...
      },
      {
        ...
        recommendation: 'REVIEW - Good match but verify backend experience',
        aiReasoning: 'Strong overall match with some considerations. Your React skills are excellent, but the backend requirements (Python) might need reinforcement in the CV.',
        description: 'Full Stack Engineer to build our core platform. Seeking someone with React and Python experience. Competitive salary, remote position.',
        generatedCV: `Jane Smith
Full Stack Engineer | Remote

EXPERIENCE
Software Engineer | TechCo | 2019-Present
- Built React frontend for SaaS platform
- Developed Python microservices handling 10k req/day
- Designed database schemas for complex queries
...
React, Python, PostgreSQL, AWS, Docker`,
      ...
      },
      {
        ...
        recommendation: 'MAYBE - Consider skill gaps in container orchestration',
        aiReasoning: 'The role offers interesting infrastructure challenges, but your Kubernetes experience might be limited. Consider if you want to focus on DevOps or prefer frontend roles.',
        description: 'DevOps Engineer needed to manage our cloud infrastructure. Kubernetes, Docker, AWS required. Lead role on team of 2.',
        generatedCV: `Mike Johnson
DevOps Engineer | Remote

EXPERIENCE
DevOps Engineer | CloudCorp | 2020-Present
- Managed AWS infrastructure for 50+ microservices
- Implemented CI/CD pipelines using Jenkins
- Reduced deployment failures by 30%

SKILLS
AWS, Docker, CI/CD, Linux, Python`,
        requiresChanges: true,
      },
    ],
  })
